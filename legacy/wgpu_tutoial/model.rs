...
pub trait DrawModel<'a> {
    fn draw_mesh(
        ...
        mesh: &'a Mesh,
        material: &'a Material,
        view_projection_bind_group: &'a wgpu::BindGroup,
        light_source_bind_group: &'a wgpu::BindGroup,
    );
    ...
    'b: 'a,
{
    fn draw_mesh(
        ...
        mesh: &'b Mesh,
        material: &'b Material,
        view_projection_bind_group: &'b wgpu::BindGroup,
        light_source_bind_group: &'b wgpu::BindGroup,
    ) {
    ...
    fn draw_mesh_instanced(
        ...
        self.set_bind_group(1, view_projection_bind_group, &[]);
        self.set_bind_group(2, light_source_bind_group, &[]);
