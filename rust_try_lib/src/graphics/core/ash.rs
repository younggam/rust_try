...
impl CoreVulkan {
    ...
    const VALIDATION_LAYERS: [&'static [u8]; 1] = [b"VK_LAYER_KHRONOS_validation"];
    ...
    fn create_instance(&mut self) {
        ...
        let raw_layer_names = Self::VALIDATION_LAYERS
            .iter()
    ...
    fn create_texture_image(&mut self) {
        let pixels = image::open(Self::TEXTURE_PATH)
    ...
    fn check_device_extension_support(&self, device: vk::PhysicalDevice) -> bool {
        ...
        for required_extension in Self::DEVICE_EXTENSIONS {
